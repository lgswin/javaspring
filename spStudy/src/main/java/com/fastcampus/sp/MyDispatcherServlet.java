...
// Project -> Build path -> add libraries -> Server runtime -> Tomcat v9.0 추가 
// Servlet의 annotation은 @Controller+@RequestMapping을 합친것
...
public class MyDispatcherServlet extends HttpServlet {
	...
	public void service(HttpServletRequest request, HttpServletResponse response) throws IOException {
		...
		try {
			Class clazz = Class.forName("com.fastcampus.sp.YoilTellerMVC");
